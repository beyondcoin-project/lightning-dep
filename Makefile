...
# This is where we add new features as beyondcoin adds them.
FEATURES :=
...
# Except for CCAN, we treat everything else as dependent on external/ beyondcoin/ common/ wire/ and all generated headers, and Makefile
