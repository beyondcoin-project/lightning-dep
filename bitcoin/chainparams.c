...
const struct chainparams networks[] = {
    ...
    {.network_name = "beyondcoin",
     ...
     .max_funding = AMOUNT_SAT_INIT(60 * ((1 << 24) - 1)),
     .max_payment = AMOUNT_MSAT_INIT(60 * 0xFFFFFFFFULL),
     .when_lightning_became_cool = 45000,
     .p2pkh_version = 25,
     .p2sh_version = 25,
     .testnet = false,
     .fee_asset_tag = NULL,
    ...
    {.network_name = "beyondcoin-testnet",
     .bip173_name = "tbynd",
     .bip70_name = "test",
     .genesis_blockhash = {{{.u.u8 = {0xe4, 0xc2, 0x3a, 0x18, 0x95, 0x82, 0xc0,
                      0xa7, 0x71, 0x95, 0x69, 0x71, 0x7b, 0xfe,
                      0xb5, 0x9b, 0x47, 0x8a, 0x20, 0x36, 0x7c,
                      0x5b, 0x36, 0xdd, 0x6f, 0xb1, 0x8b, 0x7d,
                      0xf4, 0xec, 0xab, 0x51}}}},
     .rpc_port = 14332,
     .cli = "beyondcoin-cli",
     .cli_args = "-testnet",
